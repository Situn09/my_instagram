  ...
  return (
    <div className="w-full h-full bg-[#FAFAFA]">
              ...
              <div className="flex flex-col p-5 gap-y-4 ">
                ...
                <div className="flex justify-center items-center">
                  <input
                    ...
                    value={media.caption}
                    className=" w-1/2 mx-5 px-2 py-4 bg-gray-100 border rounded outline-none hover:bg-transparent focus:bg-transparent focus:border-gray-400"
                  />
                </div>
      ...
      <div className="grid w-full max-w-screen-lg grid-cols-3 gap-6 mx-auto mt-20 ">
        ...
        {/* this is our sidebar */}
        <div className="fixed right-[5%] max-w-sm lg:hidden">
          {/* <div className="flex">
